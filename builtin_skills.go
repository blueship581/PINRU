...
// skillPromptGen is SKILL.md for the 评审项目提示词生成 skill (v2.2).
...
name: 评审项目提示词生成
description: 根据评审项目代码仓库自动生成评测提示词（Bug修复/代码生成/Feature迭代/代码理解/代码重构/工程化）
---
...
taskType: 任务类型（Bug修复 / 代码生成 / Feature迭代 / 代码理解 / 代码重构 / 工程化）
