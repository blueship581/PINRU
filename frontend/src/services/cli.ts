...
export async function checkCLI(): Promise<string> {
  return callService<string>('CliService', 'CheckCLI');
}

export async function startClaude(req: StartClaudeRequest): Promise<StartClaudeResponse> {
  return callService<StartClaudeResponse>('CliService', 'StartClaude', req);
}

export async function pollOutput(sessionId: string, offset: number): Promise<PollOutputResponse> {
  return callService<PollOutputResponse>('CliService', 'PollOutput', { sessionId, offset });
}
...
export async function listSkills(): Promise<SkillItem[]> {
  return callService<SkillItem[]>('CliService', 'ListSkills');
}
